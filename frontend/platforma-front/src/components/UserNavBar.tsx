  ...
  return (
    <div className="flex w-full m-0 bg-[#124E66] justify-between items-center p-2">
        ...
        <div className="flex p-1 sm:p-1.5 lg:p-3 xl:p-3.5 2xl:p-5">
            <div className="text-xl flex items-center gap-2 font-semibold text-white">
                <img src="/images.png" alt="avatar" className="bg-transparent rounded-full w-16 h-16 gap-1" />
                <p>username</p>
            </div>
        </div>
        {/* Here we will have a search bar */}
        <div className="flex items-center font-semibold text-black
        bg-white border-2 border-black rounded-3xl p-2 w-[50%]">
            ...
            className="bg-transparent w-full active:border-none border-none"/>
        </div>
        {/* Here we will have the user navigation links. */}
        <div className="flex justify-between items-center gap-2 p-2">
                <Link to={""} className="bg-[#808080] p-2 items-center rounded-3xl m-1">Ask question</Link>
